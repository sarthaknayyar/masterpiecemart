...
function Navbar() {
  return (
    <div className="bg-gray-200 flex justify-around items-center h-16 px-6 gap-8">
      
      <div className="flex items-center gap-8">
        <div className="mr-4 flex text-black text-2xl font-bold hover:text-current hover:no-underline">
          <Link className='text-black text-2xl font-bold hover:text-current hover:no-underline transition-transform transform hover:scale-110 hover:font-bold hover:text-3xl'>MasterPiece Mart</Link>
        </div>

        <div className="flex items-center w-80 rounded-2xl">
          <input className="input-box mr-2 w-40 rounded-2xl"  placeholder="Search MasterPiece Mart" />
          <div className="">
            <i className=""></i>
          </div>
        </div>
      ...
      <div className="flex items-center gap-8">
        <div className=" mr-4 flex">
          <Link className="text-black hover:text-current hover:no-underline transition-transform transform hover:scale-110 hover:font-bold hover:text-3xl" to="/">Shop Art</Link>
        </div>
